                ...
                Column {
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            Text("💡", fontSize = 16.sp)
                            Text(
                                "Students who enable notifications are 3× more consistent with their daily study goals.",
...
// ─────────────────────────────────────────────────────────────
// "Notifications Blocked" dialog — shown after permanent denial
// ─────────────────────────────────────────────────────────────
                ...
                Column(
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                        ...
                        TextButton(onClick = onDismiss, modifier = Modifier.fillMaxWidth()) {
                            Text("Not now", color = BpscColors.TextSecondary)
                        }
                    }
                }
            }
